...
export default function Scene({}: Props){
    ...
    if(
        ...
        return;
        //if the animations above go through that means we are ready to display the text
        isReady();
    
    // x is left and right, y is up and down, z is how close or far away it is from the screen
    ...
    //to play the intro timeline when we haven't srolled yet
    ...
    scrollTl
    //rotate can group
    .to(groupRef.current.rotation, {y: Math.PI * 2}) // rotate 360 degrees
    ...
    .to(
        groupRef.current.position, {x:1, duration: 3, ease: "sine.inOut"}, 1.3
    )
})
  return (
      <group ref={groupRef}>
